...
!  END IF
  ...
  read(10, *) dummy, dummy
  read(10, *) dummy, dummy
  read(10, *) dummy, Save_probes_data_step
  read(10, *) dummy, Save_probes_data_T_cntr_rff
  read(10, *) dummy, TextOut_skip
  read(10, *) dummy, N_of_given_probes
  PRINT '(2x,"Test ",i5," : Is it downdown")',  N_of_given_probes
...
!  DO n = 1, N_of_given_probes
  read(10, *) temp_pos(1,1)
  read(10, *) temp_pos(2,1)
!     IF (IOS.NE.0) THEN
...
!  END DO
!  CALL MPI_ABORT(MPI_COMM_WORLD, ierr)
!  read(10, *) dummy, temp_pos(1,2)
!  read(10, *) dummy, temp_pos(2,2)
!  PRINT '(2x,"Test ",i5," : Is it downdown")', temp_pos(2,2)
  close(10)
