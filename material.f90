...
! read the file
     ...
     read(10, *) dummy, dummy
!     read(10, *) dummy, dummy
     read(10, *) whole_object(n)%eps_diel
     read(10, *) whole_object(n)%Emitted_model(1)
     read(10, *) whole_object(n)%Elast_refl_type
     read(10, *) whole_object(n)%setD_see_elastic
     read(10, *) whole_object(n)%minE_see_elastic
     read(10, *) whole_object(n)%maxE_see_elastic
     read(10, *) whole_object(n)%E_elast_0
     read(10, *) whole_object(n)%E_elast_max
     read(10, *) whole_object(n)%maxD_elast
     read(10, *) whole_object(n)%dE_elast
     read(10, *) whole_object(n)%Frac_elast_highenergy

     IF (whole_object(n)%Emitted_model(1).EQ.0) whole_object(n)%Frac_elast_highenergy = 0.0_8
     read(10, *) whole_object(n)%Emitted_model(2)
     read(10, *) whole_object(n)%setD_see_inelastic
     read(10, *) whole_object(n)%minE_see_inelastic
     read(10, *) whole_object(n)%maxE_see_inelastic
     read(10, *) whole_object(n)%Frac_inelastic

     IF (whole_object(n)%Emitted_model(2).EQ.0) whole_object(n)%Frac_inelastic = 0.0_8
     read(10, *) whole_object(n)%Emitted_model(3)
     read(10, *) whole_object(n)%T_see_true_eV
     read(10, *) whole_object(n)%setD_see_true
     read(10, *) whole_object(n)%minE_see_true
     read(10, *) whole_object(n)%maxE_see_true
     read(10, *) whole_object(n)%E_see_0
     read(10, *) whole_object(n)%E_see_max
     read(10, *) whole_object(n)%maxD_see_classic
     read(10, *) whole_object(n)%k_smooth
     read(10, *) ion_wall_interaction_flag
     ...
     DO s = 1, N_spec
       read(10, *) whole_object(n)%setD_ii_ee_true(s)
       read(10, *) whole_object(n)%minE_ii_ee_true(s)
       read(10, *) whole_object(n)%maxE_ii_ee_true(s)
       read(10, *) whole_object(n)%T_ii_ee_true_eV(s)
       PRINT '(2x,"Test ",f10.3," : zzzzzzzzzzzz")', whole_object(n)%T_ii_ee_true_eV(s)
